...
const podcastService = services.find((s) => s.slug === "podcast-production")!;

export default function PodcastPage() {
  const [isHovered, setIsHovered] = useState(false);
  const s = podcastService;
      ...
      <section className="relative pt-24 sm:pt-28 md:pt-36 pb-8 sm:pb-12 px-4 sm:px-6 lg:px-12 border-b border-white/10 overflow-hidden bg-gradient-to-b from-brand-dark/80 via-brand-black to-brand-black">
        ...
        <div className="container mx-auto max-w-7xl relative z-10">
          ...
          >
            ...
            <span className="text-white/60">PODCAST PRODUCTION</span>
          </motion.div>
        ...
        <div className="container mx-auto max-w-7xl">
          ...
          <div className="pt-16 sm:pt-20">
            <div className="flex items-center gap-3 mb-10">
              ...
              <span className="text-[11px] font-mono uppercase tracking-[0.3em] text-white/50">PODCAST PACKAGES</span>
            </div>
      ...
      <section className="py-20 sm:py-28 px-4 sm:px-6 lg:px-12 bg-brand-dark text-center border-t border-white/10 relative overflow-hidden">
        ...
        <div className="container mx-auto max-w-4xl relative z-10 space-y-6">
          ...
          <p className="text-sm sm:text-base text-brand-grey max-w-xl mx-auto font-light leading-relaxed">
            Book a session, bring your ideas, and let us handle the rest — from recording to final delivery.
          </p>
          <div className="pt-3 flex flex-col sm:flex-row justify-center gap-4">
            <Link to="/contact" id="podcast-cta-bottom" className="inline-flex items-center justify-center gap-3 px-8 sm:px-10 py-4 rounded-full bg-white text-black font-mono text-xs uppercase tracking-widest font-bold hover:bg-brand-light hover:scale-105 active:scale-95 transition-all duration-300 shadow-xl">
              <span>BOOK A SESSION →</span>
            </Link>
            <Link to="/studio" className="inline-flex items-center justify-center gap-2 px-8 sm:px-10 py-4 rounded-full border border-white/20 text-white font-mono text-xs uppercase tracking-widest hover:border-white hover:bg-white/10 active:scale-95 transition-all duration-300">
