        ...
        <div className="container mx-auto max-w-6xl">
          <div className="relative aspect-[16/9] md:aspect-[21/9] rounded-3xl overflow-hidden border border-white/15 bg-brand-dark group shadow-2xl">
            <Image
              ...
              fill
              priority
              className="object-cover object-center filter contrast-[1.05] group-hover:scale-105 transition-transform duration-700"
            />
          ...
          >
            {disciplines.map((d) => {
              return (
                ...
                >
                  <Link href={`/work/${d.slug}`} className="absolute inset-0 z-20" aria-label={`Open ${d.title} case study`} />
