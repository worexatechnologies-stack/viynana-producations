                    ...
                    >
                      ...
                      <div className="relative aspect-[4/5] overflow-hidden bg-black">
                        <Image
                          ...
                          className="object-cover object-top filter saturate-[1.25] contrast-[1.08] brightness-[0.98] group-hover:scale-105 group-hover:saturate-[1.35] transition-all duration-700"
                        />
                      ...
                      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
                        ...
                        <div className="lg:col-span-5 relative aspect-[4/5] rounded-2xl overflow-hidden bg-black border border-white/10 group">
                          <Image
                            ...
                            className="object-cover object-top filter saturate-[1.25] contrast-[1.08] group-hover:scale-105 transition-transform duration-700"
                          />
              ...
              <div className="space-y-4">
                <div className="relative aspect-[16/9] rounded-2xl overflow-hidden border border-white/15 bg-black">
                  <Image
                    ...
                    fill
                    className="object-cover object-top filter saturate-[1.2] contrast-[1.05]"
                  />
