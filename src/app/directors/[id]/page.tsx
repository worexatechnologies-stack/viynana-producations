...
export default function DirectorProfilePage({
  ...
  const theme = directorThemes[id] || monochromeDirectorTheme;
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-14 items-center">
            ...
            >
              <Image
                ...
                className="object-cover object-top filter brightness-[0.9] contrast-[1.05] group-hover:scale-105 transition-transform duration-700"
              />
            ...
            >
              ...
              <div className="pt-4 flex flex-wrap items-center gap-4">
                ...
                <Link
                  href={`/contact?director=${encodeURIComponent(director.name)}`}
            ...
            <div className="p-6 rounded-2xl bg-gradient-to-br from-white/[0.04] to-transparent border border-white/15 space-y-4 flex flex-col justify-between">
              <div>
                ...
                {directors.length > 1 ? (
                  <>
                    <Link
                      href={`/directors/${nextDirector.id}`}
